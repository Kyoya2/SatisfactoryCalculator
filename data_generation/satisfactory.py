...
def jsonify(obj):
    ...
    if isinstance(obj, (list, tuple, set)):
        if isinstance(obj, tuple) and hasattr(obj, '_fields'):
            ...
            l = [jsonify(item) for item in obj]

            # If the list contain primitive types, sort them. This should reduce the git diff in
            # the autogenerated file when making small changes
            if 0 == len(l) or not isinstance(l[0], (int, str, float, bool)):
                return l
            return sorted(l)
